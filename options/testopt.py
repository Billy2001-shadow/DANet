...
def _get_test_opt():
    ...
    parser.add_argument('--loadckpt', default='./results/EfficientNet+bs=16+seed=12/checkpoints/EfficientNet+bs=16+seed=12_nodebs16-tep10-lr0.0002_best.pt',required=False, help="the path of the loaded model")
